...
namespace Imphenzia
{
    public class GradientSkyCommon : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            colorKey[0].color = Color.HSVToRGB(0f, 0f, 1f);
            colorKey[0].time = 0.0f;
            colorKey[1].color = Color.HSVToRGB(hue, saturationMid, value);
            colorKey[1].time = 0.5f;
            colorKey[2].color = Color.HSVToRGB(hue, saturationEnd, value);
            colorKey[2].time = 1f;
